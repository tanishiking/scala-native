...
object CFuncPtr0 {
  ...
  def _fromScalaFunction(fn: Function0[_], retTy: Class[_], evRet: Tag[_]): Function[Function0[_], CFuncPtr0[_]] = intrinsic
...
object CFuncPtr1 {
  ...
  def _fromScalaFunction(fn: Function1[_, _], paramTy1: Class[_], retTy: Class[_], ev1: Tag[_], evRet: Tag[_]): Function[Function1[_, _], CFuncPtr1[_, _]] = intrinsic
...
object CFuncPtr2 {
  ...
  def _fromScalaFunction(fn: Function2[_, _, _], paramTy1: Class[_], paramTy2: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], evRet: Tag[_]): Function[Function2[_, _, _], CFuncPtr2[_, _, _]] = intrinsic
...
object CFuncPtr3 {
  ...
  def _fromScalaFunction(fn: Function3[_, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], evRet: Tag[_]): Function[Function3[_, _, _, _], CFuncPtr3[_, _, _, _]] = intrinsic
...
object CFuncPtr4 {
  ...
  def _fromScalaFunction(fn: Function4[_, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], evRet: Tag[_]): Function[Function4[_, _, _, _, _], CFuncPtr4[_, _, _, _, _]] = intrinsic
...
object CFuncPtr5 {
  ...
  def _fromScalaFunction(fn: Function5[_, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], evRet: Tag[_]): Function[Function5[_, _, _, _, _, _], CFuncPtr5[_, _, _, _, _, _]] = intrinsic
...
object CFuncPtr6 {
  ...
  def _fromScalaFunction(fn: Function6[_, _, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], paramTy6: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], ev6: Tag[_], evRet: Tag[_]): Function[Function6[_, _, _, _, _, _, _], CFuncPtr6[_, _, _, _, _, _, _]] = intrinsic
...
object CFuncPtr7 {
  ...
  def _fromScalaFunction(fn: Function7[_, _, _, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], paramTy6: Class[_], paramTy7: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], ev6: Tag[_], ev7: Tag[_], evRet: Tag[_]): Function[Function7[_, _, _, _, _, _, _, _], CFuncPtr7[_, _, _, _, _, _, _, _]] = intrinsic
...
object CFuncPtr8 {
  ...
  def _fromScalaFunction(fn: Function8[_, _, _, _, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], paramTy6: Class[_], paramTy7: Class[_], paramTy8: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], ev6: Tag[_], ev7: Tag[_], ev8: Tag[_], evRet: Tag[_]): Function[Function8[_, _, _, _, _, _, _, _, _], CFuncPtr8[_, _, _, _, _, _, _, _, _]] = intrinsic
...
object CFuncPtr9 {
  ...
  def _fromScalaFunction(fn: Function9[_, _, _, _, _, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], paramTy6: Class[_], paramTy7: Class[_], paramTy8: Class[_], paramTy9: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], ev6: Tag[_], ev7: Tag[_], ev8: Tag[_], ev9: Tag[_], evRet: Tag[_]): Function[Function9[_, _, _, _, _, _, _, _, _, _], CFuncPtr9[_, _, _, _, _, _, _, _, _, _]] = intrinsic
...
object CFuncPtr10 {
  ...
  def _fromScalaFunction(fn: Function10[_, _, _, _, _, _, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], paramTy6: Class[_], paramTy7: Class[_], paramTy8: Class[_], paramTy9: Class[_], paramTy10: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], ev6: Tag[_], ev7: Tag[_], ev8: Tag[_], ev9: Tag[_], ev10: Tag[_], evRet: Tag[_]): Function[Function10[_, _, _, _, _, _, _, _, _, _, _], CFuncPtr10[_, _, _, _, _, _, _, _, _, _, _]] = intrinsic
...
object CFuncPtr11 {
  ...
  def _fromScalaFunction(fn: Function11[_, _, _, _, _, _, _, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], paramTy6: Class[_], paramTy7: Class[_], paramTy8: Class[_], paramTy9: Class[_], paramTy10: Class[_], paramTy11: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], ev6: Tag[_], ev7: Tag[_], ev8: Tag[_], ev9: Tag[_], ev10: Tag[_], ev11: Tag[_], evRet: Tag[_]): Function[Function11[_, _, _, _, _, _, _, _, _, _, _, _], CFuncPtr11[_, _, _, _, _, _, _, _, _, _, _, _]] = intrinsic
...
object CFuncPtr12 {
  ...
  def _fromScalaFunction(fn: Function12[_, _, _, _, _, _, _, _, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], paramTy6: Class[_], paramTy7: Class[_], paramTy8: Class[_], paramTy9: Class[_], paramTy10: Class[_], paramTy11: Class[_], paramTy12: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], ev6: Tag[_], ev7: Tag[_], ev8: Tag[_], ev9: Tag[_], ev10: Tag[_], ev11: Tag[_], ev12: Tag[_], evRet: Tag[_]): Function[Function12[_, _, _, _, _, _, _, _, _, _, _, _, _], CFuncPtr12[_, _, _, _, _, _, _, _, _, _, _, _, _]] = intrinsic
...
object CFuncPtr13 {
  ...
  def _fromScalaFunction(fn: Function13[_, _, _, _, _, _, _, _, _, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], paramTy6: Class[_], paramTy7: Class[_], paramTy8: Class[_], paramTy9: Class[_], paramTy10: Class[_], paramTy11: Class[_], paramTy12: Class[_], paramTy13: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], ev6: Tag[_], ev7: Tag[_], ev8: Tag[_], ev9: Tag[_], ev10: Tag[_], ev11: Tag[_], ev12: Tag[_], ev13: Tag[_], evRet: Tag[_]): Function[Function13[_, _, _, _, _, _, _, _, _, _, _, _, _, _], CFuncPtr13[_, _, _, _, _, _, _, _, _, _, _, _, _, _]] = intrinsic
...
object CFuncPtr14 {
  ...
  def _fromScalaFunction(fn: Function14[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], paramTy6: Class[_], paramTy7: Class[_], paramTy8: Class[_], paramTy9: Class[_], paramTy10: Class[_], paramTy11: Class[_], paramTy12: Class[_], paramTy13: Class[_], paramTy14: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], ev6: Tag[_], ev7: Tag[_], ev8: Tag[_], ev9: Tag[_], ev10: Tag[_], ev11: Tag[_], ev12: Tag[_], ev13: Tag[_], ev14: Tag[_], evRet: Tag[_]): Function[Function14[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _], CFuncPtr14[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _]] = intrinsic
...
object CFuncPtr15 {
  ...
  def _fromScalaFunction(fn: Function15[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], paramTy6: Class[_], paramTy7: Class[_], paramTy8: Class[_], paramTy9: Class[_], paramTy10: Class[_], paramTy11: Class[_], paramTy12: Class[_], paramTy13: Class[_], paramTy14: Class[_], paramTy15: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], ev6: Tag[_], ev7: Tag[_], ev8: Tag[_], ev9: Tag[_], ev10: Tag[_], ev11: Tag[_], ev12: Tag[_], ev13: Tag[_], ev14: Tag[_], ev15: Tag[_], evRet: Tag[_]): Function[Function15[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], CFuncPtr15[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _]] = intrinsic
...
object CFuncPtr16 {
  ...
  def _fromScalaFunction(fn: Function16[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], paramTy6: Class[_], paramTy7: Class[_], paramTy8: Class[_], paramTy9: Class[_], paramTy10: Class[_], paramTy11: Class[_], paramTy12: Class[_], paramTy13: Class[_], paramTy14: Class[_], paramTy15: Class[_], paramTy16: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], ev6: Tag[_], ev7: Tag[_], ev8: Tag[_], ev9: Tag[_], ev10: Tag[_], ev11: Tag[_], ev12: Tag[_], ev13: Tag[_], ev14: Tag[_], ev15: Tag[_], ev16: Tag[_], evRet: Tag[_]): Function[Function16[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], CFuncPtr16[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _]] = intrinsic
...
object CFuncPtr17 {
  ...
  def _fromScalaFunction(fn: Function17[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], paramTy6: Class[_], paramTy7: Class[_], paramTy8: Class[_], paramTy9: Class[_], paramTy10: Class[_], paramTy11: Class[_], paramTy12: Class[_], paramTy13: Class[_], paramTy14: Class[_], paramTy15: Class[_], paramTy16: Class[_], paramTy17: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], ev6: Tag[_], ev7: Tag[_], ev8: Tag[_], ev9: Tag[_], ev10: Tag[_], ev11: Tag[_], ev12: Tag[_], ev13: Tag[_], ev14: Tag[_], ev15: Tag[_], ev16: Tag[_], ev17: Tag[_], evRet: Tag[_]): Function[Function17[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], CFuncPtr17[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _]] = intrinsic
...
object CFuncPtr18 {
  ...
  def _fromScalaFunction(fn: Function18[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], paramTy6: Class[_], paramTy7: Class[_], paramTy8: Class[_], paramTy9: Class[_], paramTy10: Class[_], paramTy11: Class[_], paramTy12: Class[_], paramTy13: Class[_], paramTy14: Class[_], paramTy15: Class[_], paramTy16: Class[_], paramTy17: Class[_], paramTy18: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], ev6: Tag[_], ev7: Tag[_], ev8: Tag[_], ev9: Tag[_], ev10: Tag[_], ev11: Tag[_], ev12: Tag[_], ev13: Tag[_], ev14: Tag[_], ev15: Tag[_], ev16: Tag[_], ev17: Tag[_], ev18: Tag[_], evRet: Tag[_]): Function[Function18[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], CFuncPtr18[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _]] = intrinsic
...
object CFuncPtr19 {
  ...
  def _fromScalaFunction(fn: Function19[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], paramTy6: Class[_], paramTy7: Class[_], paramTy8: Class[_], paramTy9: Class[_], paramTy10: Class[_], paramTy11: Class[_], paramTy12: Class[_], paramTy13: Class[_], paramTy14: Class[_], paramTy15: Class[_], paramTy16: Class[_], paramTy17: Class[_], paramTy18: Class[_], paramTy19: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], ev6: Tag[_], ev7: Tag[_], ev8: Tag[_], ev9: Tag[_], ev10: Tag[_], ev11: Tag[_], ev12: Tag[_], ev13: Tag[_], ev14: Tag[_], ev15: Tag[_], ev16: Tag[_], ev17: Tag[_], ev18: Tag[_], ev19: Tag[_], evRet: Tag[_]): Function[Function19[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], CFuncPtr19[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _]] = intrinsic
...
object CFuncPtr20 {
  ...
  def _fromScalaFunction(fn: Function20[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], paramTy6: Class[_], paramTy7: Class[_], paramTy8: Class[_], paramTy9: Class[_], paramTy10: Class[_], paramTy11: Class[_], paramTy12: Class[_], paramTy13: Class[_], paramTy14: Class[_], paramTy15: Class[_], paramTy16: Class[_], paramTy17: Class[_], paramTy18: Class[_], paramTy19: Class[_], paramTy20: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], ev6: Tag[_], ev7: Tag[_], ev8: Tag[_], ev9: Tag[_], ev10: Tag[_], ev11: Tag[_], ev12: Tag[_], ev13: Tag[_], ev14: Tag[_], ev15: Tag[_], ev16: Tag[_], ev17: Tag[_], ev18: Tag[_], ev19: Tag[_], ev20: Tag[_], evRet: Tag[_]): Function[Function20[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], CFuncPtr20[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _]] = intrinsic
...
object CFuncPtr21 {
  ...
  def _fromScalaFunction(fn: Function21[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], paramTy6: Class[_], paramTy7: Class[_], paramTy8: Class[_], paramTy9: Class[_], paramTy10: Class[_], paramTy11: Class[_], paramTy12: Class[_], paramTy13: Class[_], paramTy14: Class[_], paramTy15: Class[_], paramTy16: Class[_], paramTy17: Class[_], paramTy18: Class[_], paramTy19: Class[_], paramTy20: Class[_], paramTy21: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], ev6: Tag[_], ev7: Tag[_], ev8: Tag[_], ev9: Tag[_], ev10: Tag[_], ev11: Tag[_], ev12: Tag[_], ev13: Tag[_], ev14: Tag[_], ev15: Tag[_], ev16: Tag[_], ev17: Tag[_], ev18: Tag[_], ev19: Tag[_], ev20: Tag[_], ev21: Tag[_], evRet: Tag[_]): Function[Function21[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], CFuncPtr21[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _]] = intrinsic
...
object CFuncPtr22 {
  ...
  def _fromScalaFunction(fn: Function22[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], paramTy1: Class[_], paramTy2: Class[_], paramTy3: Class[_], paramTy4: Class[_], paramTy5: Class[_], paramTy6: Class[_], paramTy7: Class[_], paramTy8: Class[_], paramTy9: Class[_], paramTy10: Class[_], paramTy11: Class[_], paramTy12: Class[_], paramTy13: Class[_], paramTy14: Class[_], paramTy15: Class[_], paramTy16: Class[_], paramTy17: Class[_], paramTy18: Class[_], paramTy19: Class[_], paramTy20: Class[_], paramTy21: Class[_], paramTy22: Class[_], retTy: Class[_], ev1: Tag[_], ev2: Tag[_], ev3: Tag[_], ev4: Tag[_], ev5: Tag[_], ev6: Tag[_], ev7: Tag[_], ev8: Tag[_], ev9: Tag[_], ev10: Tag[_], ev11: Tag[_], ev12: Tag[_], ev13: Tag[_], ev14: Tag[_], ev15: Tag[_], ev16: Tag[_], ev17: Tag[_], ev18: Tag[_], ev19: Tag[_], ev20: Tag[_], ev21: Tag[_], ev22: Tag[_], evRet: Tag[_]): Function[Function22[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], CFuncPtr22[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _]] = intrinsic
